...
public class MainShopController implements Initializable {
    ...
    public void addNewProduct() {
        ...
        if (productType.getSelectionModel().getSelectedItem() == ProductType.PLANT) {
            genericHib.create(new Plant(productTitleField.getText(), productDescriptionField.getText(), productManufacturerField.getText(), Double.parseDouble(productPriceField.getText()), warehouse, plantDateField.getValue()));
        } else if (productType.getSelectionModel().getSelectedItem() == ProductType.OTHER) {
            genericHib.create(new Other(productTitleField.getText(), productDescriptionField.getText(), productManufacturerField.getText(), Double.parseDouble(productPriceField.getText()), warehouse, Double.parseDouble(weightField.getText())));
        } else if (productType.getSelectionModel().getSelectedItem() == ProductType.FERTILIZER) {
            genericHib.create(new Fertilizer(productTitleField.getText(), productDescriptionField.getText(), productManufacturerField.getText(), Double.parseDouble(productPriceField.getText()), warehouse, Double.parseDouble(weightField.getText()), chemicalDescriptionField.getText()));
        } else {
            JavaFxCustomUtils.generateAlert(Alert.AlertType.WARNING, "Product error", "Error during create", "Wrong product type");
        }
        clearFields();
        loadProductListManager();
    }
    ...
    private void clearFields() {
        ...
        chemicalDescriptionField.setText(null);
    }
